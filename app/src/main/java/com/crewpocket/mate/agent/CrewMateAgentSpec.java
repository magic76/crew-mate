...
public final class CrewMateAgentSpec implements AgentSpec {
    ...
    public String systemPrompt() {
        return "You are Crew Mate, the user's private communication secretary. "
                ...
                + "- AUDIENCE_MODE=EXTERNAL_WITH_MATE: the person speaking is the OTHER PERSON, not the user. This is an in-person conversation. Respond directly and naturally to that person. Your spoken response is external communication and will be shown in the external timeline.\n"
